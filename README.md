...
## ✅ What works today (stage-1 reference, 13× adversarially reviewed)
...
Thirteen independent adversarial crypto-review rounds; every finding fixed (including a critical anchor-forge caught pre-ship in round 13 — see [docs/CRYPTO_REVIEW.md](docs/CRYPTO_REVIEW.md)). The rest of this README is the modernized specification and roadmap.
