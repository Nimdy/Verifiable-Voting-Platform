...
## ✅ What works today (stage-1 reference, 11× adversarially reviewed)
...
Eleven independent adversarial crypto-review rounds; every finding fixed (see [docs/CRYPTO_REVIEW.md](docs/CRYPTO_REVIEW.md)). The rest of this README is the modernized specification and roadmap.
