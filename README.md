...
## ✅ What works today (stage-1 reference, 16× adversarially reviewed)
...
Sixteen independent adversarial crypto-review rounds; every finding fixed (including a critical anchor-forge caught pre-ship in round 13, the chain-anchor seam's over-claims tightened in rounds 14–15, and a dual-verifier scalar-syntax divergence — latent across *all* transcript kinds — caught and fixed alongside the everlasting-privacy primitive in round 16 — see [docs/CRYPTO_REVIEW.md](docs/CRYPTO_REVIEW.md)). The rest of this README is the modernized specification and roadmap.
